@REM I don't know why, but this "batch" script breaks the Windows boot process, leading to an infinite startup loading screen
@REM That's why I rewrote this code in python.
